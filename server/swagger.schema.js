...
const apiStore = {
    ...
    get: {
        ...
        responses: {
            200: {
                description: "array with objectes about stores",
                schema: {
                    type: "array", items:
                    {
...
export const swaggerSchema = {
    schema: {
        ...
        paths: {
            ...
            "/api/product:id": apiProductId,
            "/api/productsFilter": apiProductFilters,
            "/api/productsNews": apiProductsNews,
            "/api/news:id": apiNews,
            "api/store": apiStore,
        }
    },
